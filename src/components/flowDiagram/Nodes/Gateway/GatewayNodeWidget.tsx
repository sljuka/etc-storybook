      ...
      <Container>
        ...
        >
          ...
          <PortWidget
            engine={this.props.engine}
            port={
              this.props.node.getPort("out1") || new DefaultPortModel(false)
            }
            style={{
              left: 0,
              top: 0,
          ...
          <PortWidget
            engine={this.props.engine}
            port={
              this.props.node.getPort("out2") || new DefaultPortModel(false)
            }
            style={{
              left: 48,
              top: 0,
          ...
          <PortWidget
            engine={this.props.engine}
            port={
              this.props.node.getPort("out3") || new DefaultPortModel(false)
            }
            style={{
              left: 48,
              top: 48,
